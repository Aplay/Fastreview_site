...
<div class="row">
    <div class="col-sm-6">
    <div class="form-group fg-line theme-locator">
      <?php echo $form->labelEx($modelAddCompany,'yourname',array()); ?>
...
<div class="row">
    <div class="col-sm-6">
    <div class="form-group fg-line theme-locator">
      <?php echo $form->labelEx($modelAddCompany,'yourphone',array()); ?>
...
<div class="row">
    <div class="col-sm-6">
    <div class="form-group fg-line theme-locator">
      <label for="FormAddCompany_youremail">Ваш e-mail, на который будут высылаться отчеты и уведомления</label>
      <?php 
...
<div class="row pricing-table">
                ...
                <?php 
             /*   $plans = Plan::model()->active()->findAll();
                if($plans){
                  $count = count($plans);
