...
class qqFileUploader {
  ...
  public  function handleUpload($uploadDirectory, $replaceOldFile = FALSE){
       ...
       if (!file_exists($uploadDirectory)){
            return array('error' => "Server error. Upload directory ".$uploadDirectory." not exist.");
        }
        ...
        $this->uploadName = $filename   . $ext;
         ...
         if ($this->file->save($uploadDirectory .  $filename . $ext)){
               ...
               // Resize if needed
                ...
                // заносим картинку в сессию
                $data_sess = array();
                
                if(Yii::app()->session->itemAt('images')){
                    $data = Yii::app()->session->itemAt('images');
                    if(!is_array($data)){
                        $data_sess[] = $this->uploadName;
                    } else {
                        $data[] = $this->uploadName;
                        $data_sess = $data;
                    }
                } else {
                    $data_sess[] = $this->uploadName;
               ...
               // $result = array_unique($data_sess);
                Yii::app()->session->add('images', $data_sess);
                
                return array("success"=>true,
                "path"=>"/".$uploadDirectory.$this->uploadName,
