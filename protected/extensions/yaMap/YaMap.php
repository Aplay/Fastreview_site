...
class yaMap extends CWidget
{
	...
	public function publishAssets()
	{
		...
		if(is_dir($assets)) 
		{
			...
			Yii::app()->clientScript->registerScriptFile('//api-maps.yandex.ru/2.0/?lang=ru-RU&load=package.standard,package.clusters');
			
			Yii::app()->clientScript->registerScriptFile($baseUrl . '/ymap.js', CClientScript::POS_END);
		} else 
		{
