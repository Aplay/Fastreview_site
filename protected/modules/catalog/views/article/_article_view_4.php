...
$im = '/img/cap_400x350.gif';
if($data->logotip){ 
  $data->setCap($im);
  $im = $data->getUrl('400x350','adaptiveResize',false,'logotip');
}
?>
<div class="col-xs-12 col-sm-4">
<div class="imgboxes_style4 kl-title_style_left post big-post-next" style="height:350px;">
...
<h3 class="m_title drift_ imgboxes-title trunk_1" style="padding:0;margin:0;position:relative;">
<a href="<?php echo $url; ?>">
