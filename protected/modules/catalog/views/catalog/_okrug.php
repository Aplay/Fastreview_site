...
if($districts)
{
	...
	<h2 class="org_title" style="padding-left:26px;margin-bottom:26px;">'.$model->title .' по округам '.$this->city->rodpad.'</h2>
	<div class="card">
	...
	foreach ($districts as $district) 
	{
		if(mb_strpos($district->district_name, 'округ', 0, 'UTF-8') !== false)
		{
	        ...
	        {
				$url =  Yii::app()->createAbsoluteUrl('/catalog/catalog/districtview', array('city'=>$this->city->url,  'url'=>$model->url, 'district'=>'okrug', 'district_url'=>$district->url));
