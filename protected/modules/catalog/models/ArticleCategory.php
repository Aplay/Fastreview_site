...
class ArticleCategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('article, category', 'required'),
			array('article, category', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, article, category', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'categoryId' => array(self::BELONGS_TO, 'CategoryArticle', 'category'),
		);
	}
