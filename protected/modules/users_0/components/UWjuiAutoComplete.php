...
class UWjuiAutoComplete {
    ...
    public function init() {
        return array(
            'name' => __CLASS__,
            'label' => UsersModule::t('jQueryUI autocomplete', array(), __CLASS__),
            'fieldType' => array('INTEGER'),
            'params' => $this->params,
            'paramsLabels' => array(
                'modelName' => UsersModule::t('Model Name', array(), __CLASS__),
                'optionName' => UsersModule::t('Lable field name', array(), __CLASS__),
                'emptyFieldLabel' => UsersModule::t('Empty item name', array(), __CLASS__),
                'emptyFieldValue' => UsersModule::t('Empty item value', array(), __CLASS__),
                'relationName' => UsersModule::t('Profile model relation name', array(), __CLASS__),
                'minLength' => UsersModule::t('minimal start research length', array(), __CLASS__),
            ),
        );
    }
