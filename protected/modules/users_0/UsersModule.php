 ...
 * @version $Id: UsersModule.php 132 2011-10-30 10:45:01Z mishamx $
 */
...
class UsersModule extends BaseModule {
    ...
    public $profileUrl = array("/dashboard");
    public $returnUrl = array("/dashboard");
    ...
    public static function t($str = '', $params = array(), $dic = 'user') {
        if (Yii::t("UsersModule", $str) == $str)
            return Yii::t("UsersModule." . $dic, $str, $params);
        else
            return Yii::t("UsersModule", $str, $params);
    }
    ...
    public static function doCaptcha($place = '') {
        if (!extension_loaded('gd'))
            return false;
        if (in_array($place, Yii::app()->getModule('users')->captcha))
            return Yii::app()->getModule('users')->captcha[$place];
        return false;
    }
