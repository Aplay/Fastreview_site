...
return array(
    ...
    'Username is incorrect.' => 'Пользователь не зарегистрирован.',
    'Email is incorrect.' => 'E-mail не зарегистрирован.',
    "This user's name already exists." => 'Пользователь с таким логином уже существует.',
    ...
    'Incorrect full name (length between 3 and 255 characters).'=>'Длина имени и фамилии от 3 до 255 символов.',
    'Incorrect password (minimal length 5 symbols).' => 'Минимальная длина пароля 5 символов.',
    'Incorrect username (length between 3 and 20 characters).' => 'Длина имени пользователя от 3 до 20 символов.',
    'Incorrect twitter (length maximum 255 characters).'=>'Длина twitter до 255 символов.',
    'Incorrect facebook (length maximum 255 characters).'=>'Длина facebook до 255 символов.',
    'Incorrect e-mail (length maximum 255 characters).'=>'Длина e-mail до 255 символов.',
    'Incorrect linkedIn (length maximum 255 characters).'=>'Длина linkedIn до 255 символов.',
    'Incorrect skype (length maximum 255 characters).'=>'Длина skype до 255 символов.',
    "Symbols (A-z0-9_) only." => 'В имени пользователя допускаются только латинские буквы и цифры.',
    ...
    'Your account is active.' => 'Ваша учетная запись уже активирована.',
    'Your account is deleted.' => 'Ваша учетная запись удалена.',
    'Your account is activated.' => 'Ваша учетная запись активирована.',
    ...
    'You have requested the password recovery for access to {site_name}.<br> To get the password and to set the new one follow the link: {activation_url}'=>'Вы сделали запрос на изменение пароля на сайте {site_name}.<br> Чтобы получить новый пароль - следуйте по ссылке: {activation_url}',
