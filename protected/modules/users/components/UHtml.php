...
class UHtml extends CHtml {
    public static function activeTimeField($model, $attribute, $htmlOptions = array()) {
        ...
        $monthOptions = array(
            '0' => ' - ',
            '1' => UsersModule::t('January'),
            '2' => UsersModule::t('February'),
            '3' => UsersModule::t('March'),
            '4' => UsersModule::t('April'),
            '5' => UsersModule::t('May'),
            '6' => UsersModule::t('June'),
            '7' => UsersModule::t('July'),
            '8' => UsersModule::t('August'),
            '9' => UsersModule::t('September'),
            '10' => UsersModule::t('October'),
            '11' => UsersModule::t('November'),
            '12' => UsersModule::t('December'),
        );
    ...
    public static function activeDateField($model, $attribute, $htmlOptions = array()) {
        ...
        $monthOptions = array(
            '00' => ' - ',
            '01' => UsersModule::t('January'),
            '02' => UsersModule::t('February'),
            '03' => UsersModule::t('March'),
            '04' => UsersModule::t('April'),
            '05' => UsersModule::t('May'),
            '06' => UsersModule::t('June'),
            '07' => UsersModule::t('July'),
            '08' => UsersModule::t('August'),
            '09' => UsersModule::t('September'),
            '10' => UsersModule::t('October'),
            '11' => UsersModule::t('November'),
            '12' => UsersModule::t('December'),
        );
