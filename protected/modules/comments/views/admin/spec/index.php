		...
		array(
            ...
            'buttons' => array(
                'update'  => array(
                    ...
                    'icon'  => 'pencil',
                    'url'   => 'Yii::app()->createUrl("/comments/admin/spec/update", array("id"=>$data->id))',
                    
                ),
                'view'  => array(
                    'label' => 'Снять с публикации',
                    'icon'  => 'unlock',
                    'url'   => 'Yii::app()->createUrl("comments/admin/spec/updatestatus", array("id"=>$data->id,"status"=>'.CommentSpec::STATUS_WAITING.'))',
                    'visible' => '($data->status=='.CommentSpec::STATUS_APPROVED.')?true:false;',
                    'click'=>'function(){
                ...
                'viewin'  => array(
                    'label' => 'Опубликовать',
                    'icon'  => 'lock',
                    'url'   => 'Yii::app()->createUrl("comments/admin/spec/updatestatus", array("id"=>$data->id,"status"=>'.CommentSpec::STATUS_APPROVED.'))',
                    'visible' => '($data->status=='.CommentSpec::STATUS_WAITING.')?true:false;',
                    'click'=>'function(){
                ...
                'delete' => array(
                    ...
                    'icon'  => 'times',
                    'url'   => 'Yii::app()->createUrl("/comments/admin/spec/delete", array("id"=>$data->id))',
                    'click'=>'function(){
