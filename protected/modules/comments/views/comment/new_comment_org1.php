		...
		<?php $form=$this->beginWidget('CActiveForm', array(
                ...
                'clientOptions'=>array(
                    ...
                    'afterValidate' => "js: function(form, data, hasError) {\n"
                    							."      $('#Comment_reCaptcha_em_').hide();\n"
                                                ."      if(jQuery.isEmptyObject(data)) {\n"
                                                ."	      $('#leave_comment .modal-body.for_form,#leave_comment .modal-footer').hide();\n"
                                                ."	      $('#leave_comment .modal-body.success').show();\n"
                                                ."      } else {\n"
                                                ."		  if ('Comment_reCaptcha' in data)\n" 
												."		     $('#Comment_reCaptcha_em_').show().html(data['Comment_reCaptcha']);\n"
                                                ."      }\n"
                                                ."    return false;\n"
                                                ."}\n"
                ),
...
if($comments){
	...
	foreach($comments as $row){
		...
		$this->renderPartial('application.modules.comments.views.comment._itemreview',array('model'=>$row,'ip'=>$ip, 'org_id'=>$model->id,'showcommenttext'=>true)); ?>
		</div>
