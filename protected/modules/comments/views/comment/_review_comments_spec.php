...
<div class="comment col-xs-12">
    ...
    <div class="comment-body">
      <div class="fg-line">
        <textarea id="CommentSpec_text_<?php echo $org_id; ?>_<?php echo $model->id; ?>" name="CommentSpec[text]"  class="form-control"  placeholder="Комментировать"></textarea>
        <div style="display: none;" id="CommentSpec_text_em_<?php echo $org_id; ?>_<?php echo $model->id; ?>" class="CommentSpec_text_em_<?php echo $org_id; ?>_<?php echo $model->id; ?> CommentSpec_text_em_ in-bl-error"></div>
        </div>
        <div class="clearfix"></div>
