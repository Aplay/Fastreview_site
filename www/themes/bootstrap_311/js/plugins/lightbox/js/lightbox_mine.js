...
(function() {
  ...
  var Lightbox = (function() {
    ...
    Lightbox.prototype.enable = function() {
      var self = this;
      $('body').on('click', 'a[rel^=lightbox], area[rel^=lightbox], a[data-lightbox], a[data-lightbox-open], area[data-lightbox]', function(event) {
    ...
    Lightbox.prototype.start = function($link) {
      ...
      var dataLightboxOpenValue = $link.attr('data-lightbox-open');
      var $links;
      if (dataLightboxOpenValue) {
        $links = $($link.prop("tagName") + '[data-lightbox="' + dataLightboxOpenValue + '"]');
