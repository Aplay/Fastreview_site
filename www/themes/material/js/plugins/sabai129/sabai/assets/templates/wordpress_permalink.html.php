...
<span id="sample-permalink"><?php echo strlen($slug) ? dirname($this->Entity_PermalinkUrl($entity)) : rtrim($this->Entity_PermalinkUrl($entity), '/');?>/<span id="editable-post-name" title="<?php echo __('Click to edit this part of the permalink', 'sabai');?>"><?php echo $slug_trimmed;?></span>/</span>
