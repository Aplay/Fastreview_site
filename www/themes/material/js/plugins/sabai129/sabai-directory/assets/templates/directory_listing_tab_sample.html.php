<div class="sabai-info">Open the file <strong><?php echo substr(__FILE__, strpos(__FILE__, '/wp-content/plugins/sabai-directory'));?></strong> with a text editor to see how the content on this tab is displayed.</div>
...
<h3>Description</h3>
<?php echo $entity->content_body[0]['filtered_value'];?>

<h3>Description (summarized, max. 150 characters)</h3>
<p><?php echo $entity->getSummary(150);?></p>
...
<?php foreach ($custom_fields as $field_name => $field):?>
    <dt><?php echo $field['title'];?> (<?php echo $field_name;?>)</dt>
    <dd>
...
<?php       foreach ($field['values'] as $value) $choices[] = Sabai::h($field['settings']['options']['options'][$value]);?>
...
<?php         echo __('Yes', 'sabai-directory');?>
<?php       else:?>
<?php         echo __('No', 'sabai-directory');?>
<?php       endif;?>
<?php       break;?>
...
<?php   endswitch;?>
    ...
    <dd><pre><?php print_r($field['values']);?></pre></dd>
<?php endforeach;?>
</dl>
<?php else:?>
