...
<?php       if (!empty($entity['entity']->data['content_count']['directory_listing'])):?>
                <?php printf(__('%s (%d)', 'sabai'), $this->Entity_Permalink($entity['entity'], array('bullet-icon' => 'folder-open')), $entity['entity']->data['content_count']['directory_listing']);?>
<?php       else:?>
...
<?php           if (!empty($child_term->data['content_count']['directory_listing'])):?>
                    <?php printf(__('%s (%d)', 'sabai'), $this->Entity_Permalink($child_term), $child_term->data['content_count']['directory_listing']);?>
<?php           else:?>
